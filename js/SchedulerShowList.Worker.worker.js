...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/cache-loader/dist/cjs.js?!./node_modules/babel-loader/lib/index.js!./src/worker/scheduler/SchedulerShowList.Worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!******************************!*\
  !*** ./src/api/scheduler.js ***!
  \******************************/
/*! exports provided: schedulerApi */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"schedulerApi\", function() { return schedulerApi; });\n/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api */ \"./src/api/api.js\");\n/* harmony import */ var _configs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../configs.js */ \"./src/configs.js\");\n\n\nvar api = new _api__WEBPACK_IMPORTED_MODULE_0__[\"default\"](_configs_js__WEBPACK_IMPORTED_MODULE_1__[\"appConfigs\"].apiDomain.scheduler);\nvar schedulerApi = {\n  getSchedulers: function getSchedulers() {\n    return api.get('scheduler');\n  },\n  deleteScheduler: function deleteScheduler(id) {\n    return api.put(\"delete/\" + id);\n  },\n  createScheduler: function createScheduler(data) {\n    return api.post(\"scheduler\", data);\n  },\n  updateScheduler: function updateScheduler(id, data) {\n    return api.put(\"scheduler/\" + id, data);\n  },\n  checkExistNameScheduler: function checkExistNameScheduler(name) {\n    return api.post('scheduler/checkExistScheduler/' + name);\n  },\n  getSchedulerByIdDoc: function getSchedulerByIdDoc(idDoc) {\n    return api.get('scheduler-doc/' + idDoc);\n  },\n  getSchedulerById: function getSchedulerById(id) {\n    return api.get('scheduler/' + id);\n  },\n  checkExistDocScheduler: function checkExistDocScheduler(idDoc) {\n    return api.post('scheduler/checkExistDoc/' + idDoc);\n  },\n  recurring: function recurring(data) {\n    return api.post('recurring', data);\n  },\n  getRecurring: function getRecurring() {\n    return api.get('getrecurring');\n  },\n  updateRecurring: function updateRecurring(id, data) {\n    return api.put('recurring/' + id, data);\n  },\n  getEventEachTenMinutes: function getEventEachTenMinutes() {\n    return api.get('geteventrecurring');\n  },\n  getEventRecurringByFilter: function getEventRecurringByFilter(min_date, max_date) {\n    return api.get('geteventrecurring-by-filter/' + min_date + \"/\" + max_date);\n  },\n  updateRecurringWithRecTypeEmpty: function updateRecurringWithRecTypeEmpty(id, data) {\n    return api.put('recurring-rectype-empty/' + id, data);\n  },\n  updateRecWithEventEditted: function updateRecWithEventEditted(id) {\n    return api.put(\"upate-rec-with-event-editted/\" + id);\n  }\n};\n\n//# sourceURL=webpack:///./src/api/scheduler.js?");
