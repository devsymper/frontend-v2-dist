...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/cache-loader/dist/cjs.js?!./node_modules/babel-loader/lib/index.js!./src/worker/myItem/ListTaskMyItem.Worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/cache-loader/dist/cjs.js?!./node_modules/babel-loader/lib/index.js!./src/worker/myItem/ListTaskMyItem.Worker.js":
/*!***************************************************************************************************************************************!*\
  !*** ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/babel-loader/lib!./src/worker/myItem/ListTaskMyItem.Worker.js ***!
  \***************************************************************************************************************************************/
/*! no exports provided */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ \"./node_modules/core-js/modules/es.object.to-string.js\");\n/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! regenerator-runtime/runtime.js */ \"./node_modules/regenerator-runtime/runtime.js\");\n/* harmony import */ var regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _Users_daomanhkha_Library_CloudStorage_Dropbox_code_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js\");\n/* harmony import */ var _api_uiConfig__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/api/uiConfig */ \"./src/api/uiConfig.js\");\n/* harmony import */ var _components_common_customTable_defaultFilterConfig__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/components/common/customTable/defaultFilterConfig */ \"./src/components/common/customTable/defaultFilterConfig.js\");\n\n\n\n\n\n\nonmessage = function onmessage(event) {\n  var data = event.data;\n  var action = data.action;\n\n  if (handler[action]) {\n    handler[action](data.data);\n  } else {\n    console.error(\" action \".concat(action, \" not found \"));\n  }\n};\n\nvar handler = {\n  saveUiConfig: function saveUiConfig(configs) {\n    return Object(_Users_daomanhkha_Library_CloudStorage_Dropbox_code_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__[\"default\"])( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n      var res;\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              _context.next = 2;\n              return _api_uiConfig__WEBPACK_IMPORTED_MODULE_3__[\"uiConfigApi\"].saveUiConfig(configs);\n\n            case 2:\n              res = _context.sent;\n              self.postMessage({\n                action: 'handleSaveUiConfig',\n                data: res\n              });\n\n            case 4:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee);\n    }))();\n  },\n  restoreUiConfig: function restoreUiConfig(data) {\n    return Object(_Users_daomanhkha_Library_CloudStorage_Dropbox_code_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__[\"default\"])( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n      var res, resExtraConfig;\n      return regeneratorRuntime.wrap(function _callee2$(_context2) {\n        while (1) {\n          switch (_context2.prev = _context2.next) {\n            case 0:\n              if (!data.widgetIdentifier) {\n                _context2.next = 4;\n                break;\n              }\n\n              _context2.next = 3;\n              return _api_uiConfig__WEBPACK_IMPORTED_MODULE_3__[\"uiConfigApi\"].getUiConfig(data.widgetIdentifier);\n\n            case 3:\n              res = _context2.sent;\n\n            case 4:\n              _context2.next = 6;\n              return _api_uiConfig__WEBPACK_IMPORTED_MODULE_3__[\"uiConfigApi\"].getUiConfig(data.widgetIdentifierExtraConfig);\n\n            case 6:\n              resExtraConfig = _context2.sent;\n              self.postMessage({\n                action: 'handleRestoreUiConfig',\n                data: {\n                  res: res,\n                  resExtraConfig: resExtraConfig\n                }\n              });\n\n            case 8:\n            case \"end\":\n              return _context2.stop();\n          }\n        }\n      }, _callee2);\n    }))();\n  },\n  getData: function getData(dataConfig) {\n    new Promise(function (resolve, reject) {\n      var handlerSuccess = function handlerSuccess(data) {\n        self.postMessage({\n          action: 'handleGetData',\n          data: data\n        });\n        resolve(data);\n      };\n\n      handler.prepareFilterAndCallApi(dataConfig.configs.columns, dataConfig.configs.cache, dataConfig.configs.applyFilter, handlerSuccess, dataConfig.extraConfigs);\n    });\n  },\n  prepareFilterAndCallApi: function prepareFilterAndCallApi() {\n    var columns = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;\n    var cache = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;\n    var applyFilter = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;\n    var success = arguments.length > 3 ? arguments[3] : undefined;\n    var configs = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};\n\n    if (configs.searchKey) {\n      configs.searchColumns = 'id_,name_,description_,assignee_';\n    }\n\n    Object(_components_common_customTable_defaultFilterConfig__WEBPACK_IMPORTED_MODULE_4__[\"getDataFromConfig\"])(configs.url, configs, columns, configs.tableFilter, success, 'GET', configs.header);\n  },\n  getItemForValueFilter: function getItemForValueFilter(dataConfig) {\n    new Promise(function (resolve, reject) {\n      var handlerSuccess = function handlerSuccess(data) {\n        self.postMessage({\n          action: 'handleGetItemForValueFilter',\n          data: data\n        });\n        resolve(data);\n      };\n\n      handler.prepareFilterAndCallApi(dataConfig.columns, false, true, handlerSuccess, dataConfig.options);\n    });\n  }\n};\n\n//# sourceURL=webpack:///./src/worker/myItem/ListTaskMyItem.Worker.js?./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/babel-loader/lib");
