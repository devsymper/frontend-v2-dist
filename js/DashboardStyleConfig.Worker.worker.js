...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/cache-loader/dist/cjs.js?!./node_modules/babel-loader/lib/index.js!./src/worker/dashboard/dashboard/DashboardStyleConfig.Worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/cache-loader/dist/cjs.js?!./node_modules/babel-loader/lib/index.js!./src/worker/dashboard/dashboard/DashboardStyleConfig.Worker.js":
/*!**********************************************************************************************************************************************************!*\
  !*** ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/babel-loader/lib!./src/worker/dashboard/dashboard/DashboardStyleConfig.Worker.js ***!
  \**********************************************************************************************************************************************************/
/*! no exports provided */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_array_includes_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.includes.js */ \"./node_modules/core-js/modules/es.array.includes.js\");\n/* harmony import */ var core_js_modules_es_array_includes_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_includes_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var core_js_modules_es_function_name_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.function.name.js */ \"./node_modules/core-js/modules/es.function.name.js\");\n/* harmony import */ var core_js_modules_es_function_name_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_function_name_js__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var core_js_modules_es_object_keys_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/es.object.keys.js */ \"./node_modules/core-js/modules/es.object.keys.js\");\n/* harmony import */ var core_js_modules_es_object_keys_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_keys_js__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var core_js_modules_es_string_includes_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/es.string.includes.js */ \"./node_modules/core-js/modules/es.string.includes.js\");\n/* harmony import */ var core_js_modules_es_string_includes_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_includes_js__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _api_dashboard_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/api/dashboard.js */ \"./src/api/dashboard.js\");\n\n\n\n\n\n\nonmessage = function onmessage(event) {\n  var data = event.data;\n  var action = data.action;\n\n  if (handler[action]) {\n    handler[action](data.data);\n  } else {\n    console.error(\" action \".concat(action, \" not found \"));\n  }\n};\n\nvar handler = {\n  searchStyleConfig: function searchStyleConfig(data) {\n    var styleConfig = data.styleConfig;\n    var vl = data.vl.toLowerCase();\n\n    if (vl == '') {\n      // trường hợp này sẽ lặp qua vòng lặp và gán show = true\n      for (var key in styleConfig) {\n        styleConfig[key].show = true;\n\n        if (styleConfig[key].children && Object.keys(styleConfig[key].children).length > 0) {\n          var childrens = styleConfig[key].children;\n\n          for (var key2 in childrens) {\n            childrens[key2].hidden = false;\n          }\n        }\n      }\n    } else {\n      for (var _key in styleConfig) {\n        styleConfig[_key].show = false; // ban đầu set show = false, check nếu column chưa text thì set lại bằng true\n\n        if (styleConfig[_key].children && Object.keys(styleConfig[_key].children).length > 0) {\n          var _childrens = styleConfig[_key].children;\n\n          for (var _key2 in _childrens) {\n            _childrens[_key2].hidden = true;\n\n            var title = _childrens[_key2].title.toLowerCase();\n\n            var name = _childrens[_key2].name.toLowerCase();\n\n            if (title.includes(vl) || name.includes(vl)) {\n              _childrens[_key2].hidden = false;\n              styleConfig[_key].show = true;\n            }\n          }\n        }\n      }\n    }\n\n    self.postMessage({\n      action: 'searchStyleConfigAfter',\n      data: {\n        styleConfig: styleConfig\n      }\n    });\n  }\n};\n\n//# sourceURL=webpack:///./src/worker/dashboard/dashboard/DashboardStyleConfig.Worker.js?./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/babel-loader/lib");
